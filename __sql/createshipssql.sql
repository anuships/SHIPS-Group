use shipsdb;
	...
	INSERT INTO modules (CID, TITLE, UNITS, DISC) VALUES
		...
		(3, "Audio: Introduction", 1,"Relaxation audio is kind of therapeutic tool" +
			"that helps you to learn techniques to relax yourself."), 
		(3,"Audio: Graduated Progressive Muscle Relaxation", 1,"Relaxation audio is kind of therapeutic tool " +
			"that helps you to learn techniques to relax yourself." ),
		(3, "Audio: Passive Progressive Relaxation", 1,"Relaxation audio is kind of therapeutic tool " +
			"that helps you to learn techniques to relax yourself."),
		(3, "Audio: Rotation of Awareness", 1,"Relaxation audio is kind of therapeutic tool " +
			"that helps you to learn techniques to relax yourself."),
		(3, "Audio: Breath Awareness", 1,"Relaxation audio is kind of therapeutic tool " +
				"that helps you to learn techniques to relax yourself."),
		(3, "Audio: Word Focus Meditation", 1,"Relaxation audio is kind of therapeutic tool " +
				"that helps you to learn techniques to relax yourself."),
		(3, "Audio: Alternative Nostril Breathing Meditation", 1,"Relaxation audio is kind of therapeutic tool " +
                     "that helps you to learn techniques to relax yourself."),
		(3, "Audio: Mindfull Awareness", 1,"Relaxation audio is kind of therapeutic tool " +
					"that helps you to learn techniques to relax yourself."),
		(3, "Audio: Mindfullness Meditation", 1,"Relaxation audio is kind of therapeutic tool " +
                    "that helps you to learn techniques to relax yourself."),
		(3, "Audio: Breathing Techniques", 1,"Relaxation audio is kind of therapeutic tool " +
                    "that helps you to learn techniques to relax yourself."),
		(3, "Audio: Quick Release Technique",1,"Relaxation audio is kind of therapeutic tool " +
                    "that helps you to learn techniques to relax yourself." ),
		(3, "Audio: Standing Relaxation", 1,"Relaxation audio is kind of therapeutic tool " +
                    "that helps you to learn techniques to relax yourself." ),
		(3, "Audio: Self-Hypnosis", 1,"Relaxation audio is kind of therapeutic tool " +
                    "that helps you to learn techniques to relax yourself."),
		(3, "Biofeedback", 1,"Biofeedback is kind of the therapeutic tool " +
		...
		(4, "Systematic Desensitisation", 5,"Systematic Desensitisation is kind " +
