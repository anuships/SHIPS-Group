...
//refer to https://goo.gl/MrPdIi
    ...
    ArrayList<String> programsItems = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < 10; i++) {
            ...
            expandableListDetail = dataDump.setData(programTitle, programDetail);
        }
        expandableListTitle = new ArrayList<String>(expandableListDetail.keySet());

  /*      programsItems.add("Program 1");
        programsItems.add("Program 2");
        programsItems.add("Program 3");*/
