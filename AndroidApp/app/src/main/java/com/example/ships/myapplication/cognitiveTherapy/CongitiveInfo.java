...
class CongitiveInfo {
    public static void initializeCognitiveInfo(DistortionHandler db) {
        ...
        db.addContent(new FactSheetContent(2, "2. Overgeneralization", "You see a single negative event as a never-ending pattern of defeat."));
        ...
        db.addContent(new FactSheetContent(6, "6. Magnification (Catestrophising) or Minimization", "You exaggerate the importance of things (such as your mistakes or someone else\'s achievements) or you inappropriately shrink things until they appear tiny (your own desirable qualities or someone else\'s imperfections). This is also called the \"binocular trick\"."));
        ...
        db.addContent(new FactSheetContent(10, "10. Personalization", "You see yourself as the cause of some negative external event, which in fact you were not primarily responsible for."));
    }
}
